...
if os.name == "posix":
    ...
    setup(name             = 'ema',
          ...
          packages         = ["ema", "ema.ema", "ema.internet", "ema.scheduler", "ema.scripts", "ema.serial", "ema.serial.protocol", "ema.serial.protocol.test", "ema.service"],
    ...
    setup(name             = 'ema',
          ...
          install_requires = ['twisted >= 16.2.0','twisted-mqtt','pyserial', ],
          data_files       = [ 
            (r'C:\ema',          [r'files\winnt\emad.bat',r'files\winnt\winreload.py']),
