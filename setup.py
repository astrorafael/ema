    ...
    setup(name             = 'ema',
          ...
          data_files       = [ 
              ...
              ('/usr/local/bin',   ['files/usr/local/bin/ema',
                                    ...
                                    'files/usr/local/bin/ema-activity-10',
                                    'files/usr/local/bin/ema-activity-30',
                                    'files/usr/local/bin/ema-activity-50',
                                    'files/usr/local/bin/ema-activity-70',
                                    'files/usr/local/bin/ema-activity-90',
