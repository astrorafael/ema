...
class TestEMAProtocol1(unittest.TestCase):
    ...
    RESULT =   [
        [
            ...
            ['C','A', 8.0, 0.1, 98.2, 932.9, 1015.0, 0.0, 0, 0.9, 4.14, 18.3, 65.3, 11.200, 0.0, 0, 230], 
            ['C','A', 8.0, 0.1, 93.10, 932.4, 1014.4, 0.0, 0, 0.8, 3.518, 17.6, 62.8, 11.0, 0.0, 0, 224], 
        ], 
        [
            datetime.datetime(2016, 5, 25, 1, 59, 56),
            ['C','A', 8.0, 0.1, 99.9, 932.8, 1015.1, 0.0, 0, 0.9, 4.36, 17.6, 69.2, 11.200, 0.4, 0, 230], 
            ['C','A', 8.0, 0.1, 95.4, 932.3, 1014.5, 0.0, 0, 0.8, 3.619, 16.8, 65.2, 11.0, 0.0, 0, 224], 
        ], 
        [
            datetime.datetime(2016, 4, 3, 2, 59, 56),
            ['C','A', 8.0, 0.1, 98.9, 932.7, 1016.6, 0.0, 0, 0.9, 4.757, 11.700, 50.6, 1.1, 0.4, 0, 177], 
            ['C','A', 8.0, 0.1, 95.30, 931.9, 1016.0, 0.0, 0, 0.8, 4.157, 10.9, 47.9, 0.9, 0.0, 0, 171], 
        ], 
        [
            datetime.datetime(2016, 4, 3, 3, 59, 51),
            ['C','A', 8.0, 0.1, 99.60, 932.3, 1016.4, 0.0, 0, 0.9, 4.757, 11.0, 52.3, 1.3, 0.0, 0, 177], 
            ['C','A', 7.9, 0.1, 96.5, 931.8, 1015.8, 0.0, 0, 0.8, 4.185, 10.5, 50.1, 1.0, 0.0, 0, 171], 
        ], 
        [
            datetime.datetime(2016, 1, 16, 4, 59, 56),
            ['C','A', 8.8, 0.1, 97.7, 959.2, 1111.5, 0.0, 0, 0.9, 4.231, 5.2, 56.0, -3.1, 0.0, 0, 295], 
            ['C','A', 8.6, 0.1, 90.30, 958.4, 1110.7, 0.0, 0, 0.8, 4.033, 4.6, 53.7, -3.40, 0.0, 0, 289], 
        ], 
        [
            datetime.datetime(2016, 1, 16, 5, 59, 56),
            ['C','A', 8.6, 0.1, 98.2, 959.6, 1112.8, 0.0, 0, 0.9, 4.469, 4.7, 60.5, -3.1, 0.4, 0, 295], 
            ['C','A', 8.5, 0.1, 96.30, 958.5, 1110.9, 0.0, 0, 0.8, 3.96, 3.2, 55.0, -3.8, 0.0, 0, 289], 
        ], 
        [
            datetime.datetime(2016, 5, 24, 2, 31, 26),
            ['C','A', 8.0, 0.1, 99.9, 937.7, 1020.5, 0.0, 0, 10.5, 4.26, 20.0, 57.7, 8.8, 0.0, 0, 106], 
            ['C','A', 7.9, 0.1, 99.5, 936.5, 1018.3, 0.0, 0, 0.8, 3.969, 17.0, 48.6, 7.800, 0.0, 0, 100], 
        ], 
        [
            datetime.datetime(2016, 6, 10, 20, 52, 51),
            ['C','A', 8.0, 0.1, 99.9, 936.8, 1016.0, 0.0, 0, 14.8, 359.0, 29.1, 38.6, 13.600, 0.0, 0, 330], 
            ['C','A', 7.9, 0.1, 96.0, 933.9, 1013.3, 0.0, 0, 0.8, 3.515, 26.8, 31.6, 9.1, 0.0, 0, 230], 
        ], 
        [
            datetime.datetime(2016, 6, 13, 23, 27, 35),
            ['C','A', 8.0, 0.1, 99.9, 936.4, 1016.6, 0.0, 0, 16.1, 294.0, 26.90, 35.9, 10.5, 0.4, 0, 241], 
            ['C','A', 7.9, 0.1, 94.30, 936.1, 1015.8, 0.0, 0, 0.8, 87.0, 25.40, 33.8, 8.3, 0.0, 0, 171], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 9, 59, 55),
            ['C','A', 8.200, 0.1, 99.9, 930.2, 1011.9, 0.0, 0, 22.40, 358500.0, 19.3, 56.9, 9.4, 1.4000, 0, 289], 
            ['C','A', 7.9, 0.1, 99.9, 928.3, 1009.7, 0.0, 0, 13.3, 21260.0, 18.0, 50.4, 8.0, 0.0, 0, 0], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 10, 59, 55),
            ['C','A', 8.4, 0.1, 99.9, 930.2, 1011.9, 0.0, 0, 24.90, 239800.0, 19.2, 56.3, 9.3, 1.4000, 0, 348], 
            ['C','A', 8.200, 0.1, 99.9, 928.4, 1009.8, 0.0, 0, 0.8, 130600.0, 18.0, 48.6, 7.7, 0.0, 0, 59], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 11, 59, 55),
            ['C','A', 8.5, 0.1, 99.9, 930.4, 1011.8, 0.0, 0, 3.7, 357600.0, 19.90, 50.4, 8.200, 1.9000, 0, 277], 
            ['C','A', 8.3, 0.1, 98.30, 927.4, 1008.5, 0.0, 0, 0.8, 176000.0, 18.7, 44.4, 7.2, 0.0, 0, 88], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 12, 59, 55),
            ['C','A', 8.4, 0.1, 99.9, 930.1, 1011.5, 0.0, 0, 6.5, 447300.0, 20.7, 46.8, 8.0, 2.3, 0, 318],
            ['C','A', 8.3, 0.1, 99.9, 927.4, 1008.3, 0.0, 0, 1.1, 179300.0, 19.3, 39.5, 6.4, 0.0, 0, 88], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 13, 59, 55),
            ['C','A', 8.4, 0.1, 99.9, 929.9, 1011.3, 0.0, 0, 6.0, 447400.0, 20.5, 43.0, 6.9, 2.8, 0, 336], 
            ['C','A', 8.3, 0.1, 99.9, 926.3, 1007.1, 0.0, 0, 0.8, 163100.0, 19.40, 38.8, 5.5, 0.0, 0, 0], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 14, 59, 55),
            ['C','A', 8.3, 0.1, 99.9, 928.7, 1009.8, 0.0, 0, 2.8, 291100.0, 20.7, 43.6, 7.4, 2.8, 0, 324], 
            ['C','A', 8.3, 0.1, 96.2, 926.6, 1007.5, 0.0, 0, 0.8, 142800.0, 20.0, 39.2, 6.2, 0.0, 0, 41], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 15, 59, 55),
            ['C','A', 8.3, 0.1, 99.9, 928.9, 1009.9, 0.0, 0, 2.5, 278000.0, 20.6, 44.6, 7.7, 3.8, 0, 360], 
            ['C','A', 8.200, 0.1, 94.2, 926.4, 1007.3, 0.0, 0, 0.8, 100500.0, 19.90, 41.0, 6.9, 0.0, 0, 23], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 16, 59, 55),
            ['C','A', 8.3, 0.1, 99.9, 928.4, 1009.5, 0.0, 0, 2.90, 212300.0, 20.3, 42.8, 7.2, 5.2, 0, 360], 
            ['C','A', 8.200, 0.1, 94.4, 926.4, 1007.4, 0.0, 0, 0.8, 115100.0, 19.6, 39.3, 5.7, 0.0, 0, 0], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 17, 59, 55),
            ['C','A', 8.200, 0.1, 99.9, 948.8, 1030.2, 0.0, 0, 2.3, 178200.0, 19.8, 52.6, 8.4, 2.8, 0, 295], 
            ['C','A', 8.200, 0.1, 99.9, 926.8, 1007.9, 0.0, 0, 0.8, 89140.0, 18.2, 41.2, 6.2, 0.0, 0, 23], 
        ], 
        [      
            datetime.datetime(2016, 6, 15, 18, 59, 55),
            ['C','A', 8.200, 0.1, 99.9, 928.4, 1009.8, 0.0, 0, 1.5, 139900.0, 20.0, 52.6, 9.1, 1.4000, 0, 206], 
            ['C','A', 8.200, 0.1, 92.7, 927.1, 1008.1, 0.0, 0, 0.8, 40530.0, 18.3, 48.5, 8.1, 0.0, 0, 188], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 20, 15, 22),
            ['C','A', 8.1, 0.1, 99.9, 929.2, 1011.0, 0.0, 0, 0.9, 385.0, 17.5, 54.3, 8.1, 0.0, 0, 194], 
            ['C','A', 8.1, 0.1, 96.5, 928.5, 1010.4, 0.0, 0, 0.8, 25.0, 17.1, 52.6, 7.6, 0.0, 0, 188], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 20, 59, 55),
            ['C','A', 8.1, 0.1, 99.9, 929.6, 1011.4, 0.0, 0, 0.9, 27.0, 17.7, 62.4, 9.5, 0.4, 0, 200], 
            ['C','A', 8.1, 0.1, 98.10, 928.9, 1010.8, 0.0, 0, 0.8, 7.036, 16.5, 51.7, 7.5, 0.0, 0, 188], 
        ], 
        [
            datetime.datetime(2016, 6, 15, 21, 59, 55),
            ['C','A', 8.1, 0.1, 99.9, 929.9, 1011.8, 0.0, 0, 0.9, 10.0, 18.1, 53.2, 8.4, 0.4, 0, 200], 
            ['C','A', 8.1, 0.1, 89.80, 929.2, 1010.9, 0.0, 0, 0.8, 3.601, 17.0, 49.7, 6.5, 0.0, 0, 194],  
        ], 
        [
            datetime.datetime(2016, 5, 24, 22, 59, 56),
            ['C','A', 8.1, 0.1, 94.0, 933.5, 1015.1, 0.0, 0, 0.9, 4.883, 19.7, 57.4, 10.600, 0.4, 0, 230], 
            ['C','A', 8.0, 0.1, 92.60, 932.9, 1014.5, 0.0, 0, 0.8, 3.809, 19.1, 54.3, 10.100, 0.0, 0, 206], 
        ], 
        [
            datetime.datetime(2016, 5, 24, 23, 59, 56),
            ['C','A', 8.1, 0.1, 94.60, 933.4, 1015.1, 0.0, 0, 0.9, 4.161, 19.1, 62.8, 11.100, 0.4, 0, 230], 
            ['C','A', 8.0, 0.1, 92.80, 932.7, 1014.6, 0.0, 0, 0.8, 3.419, 18.3, 57.4, 10.5, 0.0, 0, 224],  
        ]
    ]
